...
if __name__ == '__main__':
    ...
    ANALYZING_FASTTEXT_MODELS = False # false --> word2vec
    
    if ANALYZING_FASTTEXT_MODELS:
      
        MODELS_PATH = '../fasttext/models_nolemma/'
        model_type = 'FastText'
    else:
    ...
    for i, df in enumerate(performance_tables):
        ...
        plot_filename = os.path.join(output_dir, f'performance_plot_topn_{topn_val}.png')
